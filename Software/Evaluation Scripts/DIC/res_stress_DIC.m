...
if rosette_type == 'a'||rosette_type == 'A'
 load non_uniform_calibration_data_a_DIC_annular.mat;
...
elseif rosette_type == 'c'||rosette_type == 'C'
 ...
 calib_a = calib_a.*(hole_dia/2)^2 .* 1; %Adjust calibration matrices for hole dia.
 calib_b = calib_b.*(hole_dia/2)^2 .* 1;
